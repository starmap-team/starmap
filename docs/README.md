...
5. 对应模块旁的 `AGENTS.md` 或 `README.md`
...
| 开发约定 | 根 `AGENTS.md`、`docs/standards/` |
...
`.planning/` 是工作流状态，不是产品文档；其阶段结论不能覆盖当前代码。模块内 `AGENTS.md`、模块 README、契约 CHANGELOG 和测试说明因就地发现需求保留在代码目录中，这些是集中目录规则的明确例外。
