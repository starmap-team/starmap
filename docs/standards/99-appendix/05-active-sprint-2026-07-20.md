...
# 附录 05 — Active Sprint 快照(2026-07-20)

> **本文件**:`docs/standards/99-appendix/05-active-sprint-2026-07-20.md`
> **关系**:`.planning/STATE.md`(2026-07-14,声称 v3.0 100% 完成)位于 gitignored
> `.planning/` 目录,声明已不准。本文件不替代它,而是为**当前活跃工作**额外补
> 一份 git-tracked 快照,避免误读 v3.0 完成。
...
## 5. 当前 P0 数据流水线族(与 `99-appendix/01 §0` 同步)
...
| 文件 | 描述 | 本文件是否覆盖 |
|---|---|---|
| `.planning/STATE.md`(2026-07-14) | v3.0 100% 完成声明(在 gitignored 目录) | ❌ 不覆盖(声明已不准) |
| 本文件 | 当前 sprint 快照(tracked) | — |
| `.planning/ROADMAP-v2.2.md` | 路线图(在 gitignored 目录) | ❌ 不覆盖(范围不同) |
...
- 当前不动 `.planning/STATE.md`(在 gitignored 目录,且 `PROJECT.md` dirty)
...
- **历史 v3.0 声明**: `.planning/STATE.md`(在 gitignored 目录,声明已不准)