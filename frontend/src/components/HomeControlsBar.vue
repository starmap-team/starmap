...
const emit = defineEmits<{
  overviewModeChange: [mode: OverviewMode]
  updateViewMode: [mode: '2d' | '3d']
  toggleEvolution: []
}>()
</script>
...
<template>
  ...
  <div class="graph-controls">
    <div class="controls-left">
      ...
      <el-radio-group
        v-if="currentLayer === 'domain'"
        :model-value="overviewMode"
        size="small"
        class="view-tabs"
        @change="(val: string | number | boolean) => emit('overviewModeChange', val as OverviewMode)"
      >
    ...
    <div class="controls-right">
      ...
      <div class="graph-legend">
        ...
        <template v-if="showEvolution">
          <span class="legend-item"><span class="ld-line ld-line--rising" />演化·上升</span>
          <span class="legend-item"><span class="ld-line ld-line--stable" />演化·平稳</span>
          <span class="legend-item"><span class="ld-line ld-line--declining" />演化·下降</span>
        </template>
      </div>
      <el-button
        size="small"
...
.ld-line--rising { border-top: 2px dashed var(--success); }
.ld-line--stable { border-top: 2px dashed var(--muted-foreground); }
.ld-line--declining { border-top: 2px dashed var(--destructive); }
