...
from app.core.extraction.graph_writer import (
    NODE_CERTIFICATE, NODE_INDUSTRY, NODE_KNOWLEDGE_AREA, NODE_POSITION,
    NODE_SKILL, NODE_TOOL, REL_APPLIES_TO, REL_BELONGS_TO, REL_CERTIFIES,
    REL_EVOLVES_TO, REL_PREREQUISITE, REL_RECOMMENDED_FOR, REL_REQUIRES,
    REL_USES, GraphConfig, GraphNodeRef, GraphTriple, _append_unique,
    _clean_properties, _node_merge_properties, _node_ref, _skill_entry_confidence,
    _skill_entry_level, _skill_entry_source_count, _skill_entry_trend,
    _skill_entry_years, _skill_node_properties, _skill_source_count_increment,
    _validate_node_label, _validate_relationship_type, batch_write_extractions,
    build_triples_from_extraction, create_requires_relationship, get_all_skills,
    get_position_skills, merge_position, merge_skill, merge_triple,
    skill_entry_category, skill_entry_name, write_extraction_to_graph,
