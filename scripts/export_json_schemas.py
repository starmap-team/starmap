...
SCHEMA_GROUPS: dict[str, list[tuple[str, type]]] = {
    ...
    "admin": [
        ...
        ("GraphNodeListResponse", GraphNodeListResponse),
        ...
        ("AuditItem", AuditItem),
        ("AuditQueueResponse", AuditQueueResponse),
        ("BatchAuditRequest", BatchAuditRequest),
    ...
    "evolution": [
        ...
        ("EmergingSkill", EmergingSkill),
        ("EvolutionPathEntry", EvolutionPathEntry),
        ("EvolutionKpiResponse", EvolutionKpiResponse),
        ("EvolutionTrend", EvolutionTrend),
        ("EvolutionTrendsResponse", EvolutionTrendsResponse),
        ("PortabilityDetail", PortabilityDetail),
    ...
    "quality": [
        ("AlertItem", AlertItem),
        ("QualityAlertsResponse", QualityAlertsResponse),
        ("QualityTrendsResponse", QualityTrendsResponse),
