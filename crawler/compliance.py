...
def get_proxy -> str | None:
 ...
 # 技术说明：使用 random.choice 实现均匀随机选择。
 global _PROXY_LIST
 if not _PROXY_LIST:
 ...
 *,
 ...
 # 避免发送无效请求。
 # 公共 JSON API / RSS / sitemap 端点（arbeitnow/jobicy/
 ...
 # 此前 use_proxy 默认 False 且各 spider 调用均未显式开启，
 ...
 t0 = time.monotonic
 # 瞬时网络/SSL 抖动（沙盒 egress 间歇性超时）重试一次 —— 显著提升实时抓取命中率。
